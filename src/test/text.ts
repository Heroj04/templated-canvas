...
module.exports = {
  test: async function () {
    ...
    const layers = [
      new TextLayer('text', 'Test1', { x: 0, y: 0 }, { vertical: 'Top', horizontal: 'Left' }, { width: 100, height: 100 }, ['source-over'], 'Testing', { fillStyle: 'white', font: '30px' }, { vertical: 'Middle', horizontal: 'Center' }, false, false, new Map(), []),
      new TextLayer('text', 'Test1', { x: 0, y: 0 }, { vertical: 'Top', horizontal: 'Left' }, { width: 100, height: 100 }, ['source-over'], 'abcdefghijklmnopqrstuvwxyz\nABCDEFGHIJKLMNOPQRSTUVWXYZ', { fillStyle: 'black', font: '10px' }, { vertical: 'Top', horizontal: 'Left' }, false, false, new Map(), [])
    ]
